 ...
 * @node1: The pointer to the first node
 * @node2: The pointer to the second node
 * @list: The pointer to the head of the linked list
 * Return: void
 */
void swap(listint_t *node1, listint_t *node2, listint_t **list)
{
	/* Moves node2 after node1 */
	node1->next = node2->next;
	if (node1->next != NULL)
		node1->next->prev = node1;

	/* Moves node1 before node2 */
	node2->next = node1;
...
/**
 * cocktail_sort_list - sorts a doubly linked list in an ascending order using
