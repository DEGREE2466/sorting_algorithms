...
/**
 * print_range - prints range of all elements from an array
 * @array: the array to be sorted
 * @start: the start index of the range to be printed
 * @end: the end index of the range to be printed
 */
 ...
 * @array: the array to be sorted
 * @start: start index of the first bitonic sequence
 ...
 * @array: arrayi to sort
 * @start: start index of the bitonic sequence
 * @count: length of the bitonic sequence
 * @direction: sorting direction (1 for ascending, 0 for descending)
 * @int_size: size of the array
 */
